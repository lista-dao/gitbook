...
注意：本页面解释了LISTA在启动时的代币经济模型。要获取最新的代币经济信息，请参考[此页面](./)。
...
其余18%将被锁定，直到2025年6月的一年悬崖期结束。从2025年6月开始，这部分将按季度线性解锁，持续两年，直到2027年3月。
...
在启动时，分配给社区激励的代币供应量将用于推动各种DeFi活动，如LP奖励、lisUSD单独质押池等。

LISTA代币向这些社区激励的发放将从7月开始，并将按每年1/√2的递减率持续发放，为期20年，直到2044年6月。
...
后半部分：Lista代币发放的后半部分（第一年每月4,886,325.5 LISTA）将用于社区激励，但不会立即发放。发放量将根据Lista平台部署的进展逐渐增加。增加的发放量将被限制在每周1,221,581 LISTA，或换句话说，长期来看每月4,886,325.5 LISTA。
...
在启动时，分配给生态系统激励的总代币供应量的3.50%将被解锁。
