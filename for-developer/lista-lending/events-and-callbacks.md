...
The ERC-4626 curator vault layer emits the standard `Deposit`/`Withdraw`/`Transfer` events plus its own lifecycle and configuration set, declared in `moolah-vault/libraries/EventsLib.sol`. Two of them will waste your time:
