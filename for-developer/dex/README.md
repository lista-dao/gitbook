...
* [Architecture & Mechanics](mechanics.md) — Lista-specific deployment details (fee tiers, NFT name, upgradeable position manager, pool init-code hash) and how to build against the V3 fork.
