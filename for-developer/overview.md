...
| **Lista Rights** | Reward distribution for the **holder** emission programme. The same two contract names are deployed once per programme — lending emission and bStock emission are on [BSC Core](lista-lending/smart-contract-bsc-core.md), credit emission on [BSC Credit](lista-lending/smart-contract-bsc-credit.md) — so match the programme, not the name. | [README](lista-rights/README.md) | [Smart Contract](lista-rights/smart-contract.md) |
