...
`ListaStakeManager` is what you call to stake, queue a withdrawal, and claim:
...
All of these are user-callable on `ListaStakeManager`; the address is on [Smart Contract](smart-contract.md).
