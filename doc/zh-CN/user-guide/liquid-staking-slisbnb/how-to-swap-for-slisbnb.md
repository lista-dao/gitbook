...
#### 步骤 1：打开 Binance Wallet <a href="#step-1-open-binance-web3-wallet" id="step-1-open-binance-web3-wallet"></a>

1. 在您的设备上启动 Binance Wallet。
2. 确保您已登录并且钱包中有 BNB。

#### 步骤 2：导航至 Swap <a href="#step-2-navigate-to-swap" id="step-2-navigate-to-swap"></a>
...
3. 在“To”部分，从下拉菜单中选择 **slisBNB** 作为您想要接收的代币。

#### 步骤 4：查看兑换详情 <a href="#step-4-review-the-swap-details" id="step-4-review-the-swap-details"></a>
