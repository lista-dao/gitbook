...
价格稳定模块（PSM）是一个关键组件，旨在通过促进中心化稳定币与lisUSD之间的无缝转换，维持lisUSD的稳定性和可用性。以下是其主要功能的详细介绍：
...
注意：0%的费用不是永久的。未来，如果lisUSD的交易价格出现溢价，可能会引入铸币费，费用调整将以0.01%的精确增量进行。
...
价格稳定模块（PSM）在启动时的铸币上限为500万lisUSD，支持最多500万中心化稳定币的转换。
...
对于希望将lisUSD兑换回中心化稳定币的用户，将适用每日限额50万lisUSD，受限于金库中的可用储备。
